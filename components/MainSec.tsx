  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-5 lg:pt-8 padding-container items-start pt-4 xl:px-28'>
        <div className='flex flex-col gap-6'>
            ...
            <p>A selective platform to connect great tallents <br /> around the globe, build yours now</p>
            <div className='flex gap-1'>
                <button
                    className='hidden lg:flex bg-white text-black  px-6 opensans-font-regular text-[14px] py-[2px] button-style relative'>
